...
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_category` (
...
-- 3. 商品表 / Product Table
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_product` (
...
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_product_card` (
...
-- 5. 订单表 / Order Table
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_order` (
...
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_order_card` (
...
-- 7. 争议表 / Dispute Table
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_dispute` (
...
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_announcement` (
...
-- ============================================================
CREATE TABLE IF NOT EXISTS `ldc_setting` (
